...
foreach(var employee in employees)
{
    ...
    {
        employeeWithMaxResult = employees;
    }
}

Console.WriteLine("Najlepszy wynik ma :" + employeeWithMaxResult.Name + " " + employeeWithMaxResult.Surname + " " + employeeWithMaxResult.Age);
